...
ls Dokumenty ABC> dirlist 2>&1
cat filename | less; more
grep (search)
cat filename | grep -n -search_string
sort
Symbol	Descriptions
...
gdebi - instaluje dodatkowe pakiety
crontab -l
crontab -r
0 */2 * * * /home/ukasz/script2.sh
*/1* * * * *  $HOME/script2.sh
display <pic>.png
xdg-open <pdf>.pdf gio open <pdf>.pdf
